...
public class Main {
	...
	/**
	 * @param args Main para probar que la clase funciona, donde esta nuestro menu de opciones
	 * donde el usuario eligira la opcion que quiera realizar y se crea una cuenta
	 * por defecto.
	 */
	...
	/**
	 * El metodo recibe datos de una cuenta y segun la opcion elegida por el usuario
	 * realizara la operacion seleccionada.
	 * @param cuenta1 recibe una cuenta
	 * @param cantidad recibe la cantidad de la cuenta
	 * @param opcion recibe la opcino de lo que quiere hacer el usuario 
	 * ingresar o retirar una cantidad
	 */
